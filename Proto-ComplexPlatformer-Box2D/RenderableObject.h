...
// - offers render method for graphics rendering
class agp::RenderableObject : public Object
{
	protected:
		...
		Color _color;
		Sprite* _sprite;
		bool _visible;			// if false, does not render
		bool _focused;			// if true, fills with _focusColor
	...
	public:
		...
		// core game rendering
		virtual void render(SDL_Renderer* renderer, Transform camera);
